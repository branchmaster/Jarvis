...
async def reedme(event):
    await event.edit(
        ...
        "\n[One4uBot's README.md file](https://github.com/nmayorga78/Jarvis/blob/sql-extended/README.md)"
...
async def repo_is_here(wannasee):
    ...
    await wannasee.edit(
        "[Click here](https://github.com/nmayorga78/Jarvis) to open One4uBot's GitHub page."
    )
